...
//             try {
//                 // const response = await fetch('https://v1.nocodeapi.com/venkatesh01/spotify/KRZPvbQQgIghnUHx/search?q=all&type=track');
//                 if (!response.ok) {
...
//                                             <button onClick={() => handlePlayPause(track)} className='play-btn'>
